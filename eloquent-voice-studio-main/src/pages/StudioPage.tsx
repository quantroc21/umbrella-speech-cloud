...
import { SilenceCutter } from "@/components/SilenceCutter";
...
const StudioPage = () => {
  ...
  // Use the hook for user profile & credits
  const { user, creditBalance, refreshCredits } = useProfile();
  ...
  useEffect(() => {
    fetchVoices();
  }, [user]); // Re-fetch voices when user changes (auth state)
      ...
      <div className="min-h-screen bg-background">
        <div className="flex flex-col lg:flex-row h-[calc(100vh-64px)]">
          ...
          <div className="flex-1 lg:w-[70%] flex flex-col border-r border-border">
            ...
            <div className="flex-1 p-6 flex flex-col overflow-y-auto">
              ...
              <div className="max-w-5xl mx-auto w-full flex-1 flex flex-col min-h-0">
                ...
                <div className="flex-1 flex flex-col gap-4 mt-6 min-h-[400px]">
                  <TextInput
                    value={text}
                    onChange={setText}
                ...
                <div className="mt-6 pt-4 pb-2 shrink-0">
                  <AudioPlayer audioUrl={audioUrl} isGenerating={isGenerating} onAudioProcessed={setAudioUrl} />
                  <SilenceCutter
                    audioUrl={audioUrl}
                    onAudioProcessed={(newUrl) => setAudioUrl(newUrl)}
                  />
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:w-[30%] bg-card h-full border-t lg:border-t-0">
            ...
            {/* Voice Grid - Flexible Height */}
            <ScrollArea className="flex-1 border-b border-border bg-card/50">
              <div className="p-6">
            ...
            <div className="border-t border-border bg-card">
              ...
              >
                <CollapsibleTrigger asChild>
                  <Button variant="ghost" className="w-full flex items-center justify-between p-4 h-auto rounded-none hover:bg-secondary/50">
                    <div className="flex items-center gap-2">
                      <Settings2 className="w-4 h-4 text-muted-foreground" />
                      <span className="font-semibold text-sm">Advanced Voice Settings</span>
                    </div>
                    {isSettingsOpen ? (
                ...
                <CollapsibleContent>
                  <ScrollArea className="h-[300px] p-6 pt-0 border-t border-border/50">
                    <AdvancedSettings
