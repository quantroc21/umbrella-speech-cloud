...
# --- ASYNC WARMUP (NON-BLOCKING) ---
def async_warmup():
    import time
    print("WARMUP: Waiting 5s before triggering compilation...")
    time.sleep(5)
    print("WARMUP: Triggering Regional Compilation now...")
    try:
        manager.warm_up(manager.tts_inference_engine)
        print("WARMUP: Compilation Complete! System fully optimized.")
    except Exception as e:
